...
public class ConfigurationPermissionDefinitionProvider : PermissionDefinitionProvider
{
    public override void Define(IPermissionDefinitionContext context)
    {
        ...
        var hQTaskPermission = myGroup.AddPermission(ConfigurationPermissions.HQTasks.Default, L("Permission:HQTasks"));
        hQTaskPermission.AddChild(ConfigurationPermissions.HQTasks.Create, L("Permission:Create"));
        hQTaskPermission.AddChild(ConfigurationPermissions.HQTasks.Edit, L("Permission:Edit"));
        hQTaskPermission.AddChild(ConfigurationPermissions.HQTasks.Delete, L("Permission:Delete"));
    }
